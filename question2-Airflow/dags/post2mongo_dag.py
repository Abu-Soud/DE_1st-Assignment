...
#Opertators
    ...
    CSV = BashOperator(
        task_id='CSV',
        bash_command='psql postgresql://postgres:postgres@postgres:5432 -c "\copy Employees to \'/home/airflow/data/{{ti.xcom_pull(key="file_id", task_ids=["id"])[0]}}.csv\' csv header ;"',
        dag=dag)
